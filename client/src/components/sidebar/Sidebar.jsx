              ...
              <>
                ...
                <li className="menu-item">
                  ...
                  >
                    ...
                    <span className="menu-link-text">Contacts Information</span>
                  </NavLink>
                </li>
                <li className="menu-item">
                  <NavLink
                  ...
                  >
                    ...
                    <span className="menu-link-text">Profile Form</span>
                  </NavLink>
                </li>
              </>
            ) : null}
              ...
              <>
                ...
                <li className="menu-item">
                  ...
                  >
                    ...
                    <span className="menu-link-text">FAQ Page</span>
                  </NavLink>
                </li>
              </>
            ) : null}
              ...
              <>
                <li className="menu-item">
                  ...
                  >
                    ...
                    <span className="menu-link-text">Profiling</span>
                  </NavLink>
                </li>
                <li className="menu-item">
                  <NavLink
                  ...
                  >
                    ...
                    <span className="menu-link-text">Créer un modèle</span>
                  </NavLink>
                </li>
                <li className="menu-item">
                  <NavLink
                  ...
                  >
                    ...
                    <span className="menu-link-text">Modèles</span>
                  </NavLink>
                </li>
                <li className="menu-item">
                  <NavLink
                  ...
                  >
                    ...
                    <span className="menu-link-text">Télécharger</span>
                  </NavLink>
                </li>
                <li className="menu-item">
                  <NavLink
                  ...
                  >
                    ...
                    <span className="menu-link-text">Dataset Reader</span>
                  </NavLink>
                </li>
              </>
            ) : null}
